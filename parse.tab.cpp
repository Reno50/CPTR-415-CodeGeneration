...
{
       0,    89,    89,   103,   109,   113,   117,   125,   133,   136,
     140,   145,   151,   160,   163,   166,   169,   172,   175,   179,
     183,   188,   192,   196,   200,   203,   206,   209,   212,   215,
     218,   221,   224,   227,   230,   233,   236,   239,   242,   245,
     249,   253,   257,   261,   265,   268,   271,   274,   277,   280,
     283,   286,   289,   292,   298,   301,   304,   307,   310,   313,
     316,   319,   322,   325,   328,   331,   334,   337,   341,   346
};
#endif
...
#line 1693 "parse.tab.cpp"
  ...
  case 13: /* type: I32  */
#line 160 "rustish_parser_file.y"
...
#line 1701 "parse.tab.cpp"
    break;

  case 14: /* type: BOOL  */
#line 163 "rustish_parser_file.y"
                      {
                  (yyval.type_node) = new TypeNode(RustishType::bool_t);
               }
#line 1709 "parse.tab.cpp"
    break;

  case 15: /* type: LSQUARE I32 SEMICOLON number RSQUARE  */
#line 166 "rustish_parser_file.y"
                                                      {
                  (yyval.type_node) = new TypeNode(RustishType::i32array_t); // TODO: Add the length into this, otherwise typechecking isn't possible with length
               }
...
#line 169 "rustish_parser_file.y"
                                                       {
                  (yyval.type_node) = new TypeNode(RustishType::boolarray_t);
               }
#line 1725 "parse.tab.cpp"
    break;

  case 17: /* type: LSQUARE I32 RSQUARE  */
#line 172 "rustish_parser_file.y"
                                     {
                  (yyval.type_node) = new TypeNode(RustishType::i32array_t);
               }
#line 1733 "parse.tab.cpp"
    break;

  case 18: /* type: LSQUARE BOOL RSQUARE  */
#line 175 "rustish_parser_file.y"
                                      {
                  (yyval.type_node) = new TypeNode(RustishType::boolarray_t);
               }
...
#line 179 "rustish_parser_file.y"
                                                             { // Note that this doesn't leave room for variables mixed in with statements :/ Halterman's grammar verbatim
...
#line 1912 "parse.tab.cpp"
    break;

  case 40: /* funcCallExp: identifier LPAREN usedArgs RPAREN  */
#line 249 "rustish_parser_file.y"
                                                   {
...
#line 253 "rustish_parser_file.y"
                            {
...
#line 257 "rustish_parser_file.y"
                                           {
...
#line 2045 "parse.tab.cpp"
    break;

  case 56: /* expression: FALSE  */
#line 304 "rustish_parser_file.y"
                       {
...
#line 341 "rustish_parser_file.y"
                            {
...
#line 351 "rustish_parser_file.y"
